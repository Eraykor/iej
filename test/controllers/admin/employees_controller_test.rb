...
class Admin::EmployeesControllerTest < ActionController::TestCase
  ...
  test "should create admin_employee" do
    assert_difference('Admin::Employee.count') do
      post :create, admin_employee: { email: @admin_employee.email, first_name: @admin_employee.first_name, id_number: @admin_employee.id_number, last_name: @admin_employee.last_name, organization: @admin_employee.organization, phone: @admin_employee.phone }
    end
  ...
  test "should update admin_employee" do
    patch :update, id: @admin_employee, admin_employee: { email: @admin_employee.email, first_name: @admin_employee.first_name, id_number: @admin_employee.id_number, last_name: @admin_employee.last_name, organization: @admin_employee.organization, phone: @admin_employee.phone }
    assert_redirected_to admin_employee_path(assigns(:admin_employee))
  end
